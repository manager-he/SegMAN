...
CFG="segmentation/local_configs/segman/tiny/segman_t_wound_bce_dice_focal_complex_aug_boundary.py"
WORK_DIR="segmentation/work_dirs/smoke_segman_t_wound_bce_dice_focal_complex_aug_boundary"
